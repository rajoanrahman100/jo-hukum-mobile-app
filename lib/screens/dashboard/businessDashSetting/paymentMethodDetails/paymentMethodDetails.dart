              ...
              children: [
                                  ...
                                  child: ListView.builder(
                                    ...
                                    itemBuilder: (_, index) {
                                      return Obx(() => CheckboxListTile(
                                        ...
                                        value: payC.paymentMethodNames
                                            .contains(payC.paymentModelClass.value.results[index].name),
                                        onChanged: (bool selected) {
                                          if (selected == true) {
                                            payC.onSelect(
                                                payC.paymentModelClass.value.results[index].name,
                                                selected,payC.paymentModelClass.value.results[index].sId
                                            );
                ...
                WelcomeScreenButton(
                    ...
                    callback: () {
                      ...
                      payC.updateBusinessData(context, boxStorage.read(MY_BUSINESS_ID), payC.paymentMethodID);
                    }),
              ],
            ),
          ),
