          ...
          child: Padding(
            ...
            child: Column(
              children: [
                Row(
                  children: [
                    VisitorHistoryWidget(size: size,visitorCount: 17,title: "Unique Visitor",color: kBlueColor,),
                    width10,
                    VisitorHistoryWidget(size: size,visitorCount: 17,title: "Total Visitor",color: kBlueColor),
                  ],
                ),
                size10,
                Container(
                ...
                Row(
                  children: [
                    CtaCountWidget(size: size,count: 10,title: "Mobile",color: kBlueColor,),
                    width10,
                    CtaCountWidget(size: size,count: 20,title: "Desktop",color: kBlueColor),
                  ],
                ),
