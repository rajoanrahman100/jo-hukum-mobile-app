          ...
          children: [
            Row(
              children: [
                ...
                width10,
                Obx(() =>
                    VisitorHistoryWidget(size: size, visitorCount: weekController.visitorCount.value.totalVisits??0, title: "To"
                        "tal Visitor", color: kBlueColor)),
              ],
            ),
            size10,
            Container(
            ...
            Obx(()=>Row(
              children: [
                ...
                width10,
                CtaCountWidget(size: size, count: weekController.ctaCount.value.fromDesktop??0, title: "Desktop", color:
                kBlueColor),
              ],
            ),)
          ],
