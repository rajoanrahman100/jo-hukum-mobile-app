                                ...
                                builder: (context) {
                                  return Dialog(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: containerBoxDecoration(borderRadius: 10.0),
                                      child: Column(
                                        children: [
                                          Expanded(
                                              child: Obx(
                                            () => businessController.businessData.value.results == null
                                                ? Center(child: spinKit)
                                                : businessController.businessData.value.results.length == 0
                                                    ? Center(
                                                        child: textUbuntu(
                                                            "You are not added any "
                                                            "business yet",
                                                            kPrimaryPurple,
                                                            fontSize: 18.0))
                                                    : Container(
                                                        child: SizedBox.expand(
                                                          child: Padding(
                                                            ...
                                                            child: ListView.builder(
                                                              itemCount:
                                                                  businessController.businessData.value.results.length,
                                                              itemBuilder: (_, index) {
                                                                var obj = businessController.businessData.value;

                                                                return ListTile(
                                                                  title: textUbuntu(
                                                                      businessController.businessData.value
                                                                          .results[index].location.businessName,
                                                                      kBlackColor,
                                                                      fontSize: 16,
                                                                      maxLine: 2),
                                                                  leading: Icon(
                                                                  ...
                                                                  onTap: () {
                                                                    businessController
                                                                        .setMyBusinessSlug(obj.results[index].slug);
                                                                    businessController
                                                                        .setMyBusinessID(obj.results[index].sId);
                                                                    businessController.setMyBusinessName(
                                                                        obj.results[index].location.businessName);
                          ...
                          child: Container(
                              ...
                              child: Row(
                                children: [
                                  Obx(() => Expanded(
                                          child: Center(
                                        child: textUbuntu("${businessController.myBusinessName.value}", kPrimaryPurple,
                                            fontSize: 16, fontWeight: weight500),
                                      ))),
                                  Icon(
                                      ...
                                      child: Column(
                                        children: [
                                          Expanded(
                                              child: Obx(
                                            () => businessController.businessData.value.results.length == 0
                                                ? textUbuntu("No Business Found", kPrimaryPurple)
                                                : Container(
                                                    child: SizedBox.expand(
                                                      child: Padding(
                                                        padding: const EdgeInsets.all(15.0),
                                                        child: ListView.builder(
                                                          ...
                                                          itemBuilder: (_, index) {
                                                            ...
                                                            return ListTile(
                                                              title: textUbuntu(
                                                                  businessController.businessData.value.results[index]
