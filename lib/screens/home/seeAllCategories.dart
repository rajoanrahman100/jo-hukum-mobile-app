...
import 'categorySubcategories.dart';
                                  ...
                                  return GestureDetector(
                                    onTap: () {
                                      Get.to(() => CategorySubcategories(
                                            sublist: categoryController.resultDataClass[index].subCategories,
                                            categoryName: categoryController.resultDataClass[index].name,
                                          ));
                                    },
                                    child: Container(
