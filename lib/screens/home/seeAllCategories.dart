      ...
      body: Responsive(
        mobile: Obx(
          () => categoryController.resultDataClass.length == 0
              ...
              : checkConnect.isOnline.value == true
                  ? Container(
                  ...
                  : Center(
                      child: Column(
                        ...
                        children: [
                          Image.asset("assets/images/no_internet.png",height: size.height/2.5,),
                          size10,
                          textUbuntu("OOPS!", kPrimaryPurple, fontSize: 40.0, fontWeight: weight500),
                          size20,
                          textUbuntu("No Internet Connection found", kBlackColor.withOpacity(0.3), fontSize: 18.0, fontWeight: weight400),
                          textUbuntu("Check your connection", kBlackColor.withOpacity(0.3), fontSize: 18.0, fontWeight: weight400),
                          size20,
