class CategoryBusinessData {
  ...
  CategoryBusinessData({this.took, this.timedOut, this.sShards, this.hits, this.suggest});

  CategoryBusinessData.fromJson(Map<String, dynamic> json) {
    took = json['took'];
